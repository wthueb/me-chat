...
- support/validate multiple meables in a single message (multiple links, attachments)
- fix emoji meable detection (`test_multiple_emoji`)
- fix edit gate
...
- add gui for making debugging easier
    - might be best to just use https://github.com/ReagentX/imessage-exporter exporter
